...
export function AdminHeader({ title, subtitle, onBack }: { title: string; subtitle?: string; onBack?: () => void }) {
  ...
  return <View style={styles.header}>
    ...
    <Pressable onPress={logout} style={styles.logout}><Ionicons name="log-out-outline" size={14} color="#BE123C" /><LocalizedText style={styles.logoutText}>خروج</LocalizedText></Pressable>
  </View>;
}
