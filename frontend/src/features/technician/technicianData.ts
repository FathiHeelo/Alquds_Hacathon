...
export const technicianRequests: readonly TechnicianRequestItem[] = [
  { id: "old_city_plumbing_leak", customerName: "أحمد", problem: "تسريب سيفون تحت المجلى", categoryId: "plumbing", category: "سباكة وصحية", area: "البلدة القديمة", distanceKm: 0.8, fairPrice: "110–150 ₪", urgency: "عاجل", createdAt: "منذ دقيقتين", latitude: 31.7807, longitude: 35.2326, description: "المي بتنقط بغزارة من تحت مجلى المطبخ عند فتح الحنفية، والماسورة البلاستيك تبدو مشقوقة.", state: "new" },
  { id: "wadi_joz_ac", customerName: "ليان", problem: "المكيّف لا يبرّد ويصدر صوتاً", categoryId: "ac", category: "تكييف وتبريد", area: "وادي الجوز", distanceKm: 1.4, fairPrice: "140–190 ₪", urgency: "اليوم", createdAt: "منذ 12 دقيقة", latitude: 31.7938, longitude: 35.2361, description: "المكيّف يعمل لكن الهواء غير بارد ويوجد صوت اهتزاز واضح من الوحدة الداخلية.", state: "viewed" },
  { id: "sheikh_jarrah_electric", customerName: "مريم", problem: "القاطع الرئيسي يفصل باستمرار", categoryId: "electrical", category: "كهرباء", area: "الشيخ جراح", distanceKm: 2.1, fairPrice: "160–220 ₪", urgency: "عاجل", createdAt: "منذ 20 دقيقة", latitude: 31.7888, longitude: 35.2298, description: "القاطع الرئيسي يفصل كلما تم تشغيل سخان المياه، ونحتاج فحصاً آمناً للتوصيلات.", state: "new" },
  { id: "silwan_carpentry", customerName: "خليل", problem: "باب خزانة المطبخ مكسور", categoryId: "carpentry", category: "نجارة", area: "سلوان", distanceKm: 2.8, fairPrice: "90–130 ₪", urgency: "عادي", createdAt: "منذ 35 دقيقة", latitude: 31.7708, longitude: 35.2351, description: "مفصلة باب خزانة المطبخ انفصلت من الخشب والباب أصبح مائلاً.", state: "offered" }
] as const;
